...
class MatchFour extends Component {
    render() { 
        return (
                    ...
                    <div className="match__wrapper">
                        <ul className="filter-btns nav nav-pills" id="pills-tab-match" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="filter-btn nav-link active" id="pills-upcoming-tab" data-bs-toggle="pill" data-bs-target="#pills-upcoming" type="button" role="tab" aria-controls="pills-upcoming" aria-selected="true">Indian Skull</button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="filter-btn nav-link" id="pills-finished-tab" data-bs-toggle="pill" data-bs-target="#pills-finished" type="button" role="tab" aria-controls="pills-finished" aria-selected="false">Empire Gamers</button>
                            </li>
                        </ul>
                                                ...
                                                <div className="match__item-inner">
                                                    ...
                                                    <div className="match__item-bottom">
                                                        <ul className="match__item-bottomList">
                                                            ...
                                                            <li className="match__vs"><h3>{val.result}</h3></li>
                                                            <li className="match__team">
                                                                <div className="match__team-inner">
                                                                    <div className="match__team-thumb">
