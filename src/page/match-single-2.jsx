...
import MatchFive from "../component/section/match/matchfive";
...
let MatchItemSingle = [
    {
        bgImgUrl: 'assets/images/match/match-single-2.jpg',
...
class MatchSingleTwo extends Component {
    render() { 
        return (
            <Fragment>
                <Header />
                <PageHeader title={'Match Single 2'} curPage={'Match Single 2'} />
