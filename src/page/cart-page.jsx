                            ...
                            <div className="cart-bottom">
                                <div className="cart-checkout-box">
                                    ...
                                    <form className="cart-checkout" action="/">
                                        ...
                                        <button type="submit" className="default-btn reverse-effect m-2"><span>Proceed to Checkout</span></button>
                                    </form>
                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 col-12">
                                            <div className="calculate-shiping">
                                                ...
                                                <button type="submit" className="default-btn reverse-effect"><span>Update Total</span></button>
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-12">
